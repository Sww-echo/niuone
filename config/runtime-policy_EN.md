...
| `.local-data/runtime/watchlist_tracker.db` | Private watchlist groups, simulated fills, quotes with provider time/finality, and progress and failures for the latest 20 quote jobs |
