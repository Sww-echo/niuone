...
| `DASHBOARD_NIUONE_FORWARD_COHORT_START` | `2026-09-03` | First-entry date admitted to the strict-forward cohort | Read by a subsequent Cron cycle; changing it requires a new protocol lock |
