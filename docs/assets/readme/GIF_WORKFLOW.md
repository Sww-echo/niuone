...
| `theme-strength.gif` | `/niuone-mainline` | 1200 × 675 | 8 fps | 8–10 秒 | 展开题材代表股、筛选已确认题材并再次展开代表股 |
...
1. 从题材强度页开始，让跨日确认主线、日内观察主线、市场状态和覆盖率四张摘要卡完整可见。
2. 点击日内观察题材的龙头入口，展开代表股列表并停留约 1 秒。
3. 点击“已确认”筛选，只保留已经确认的题材。
4. 点击筛选结果中的龙头入口，再次展开代表股列表并停留约 1–2 秒。

摘要卡、题材列表和展开内容必须同时处于可读范围；不要裁切为只剩单张卡片，也不要用静态截图轮播代替真实点击。
